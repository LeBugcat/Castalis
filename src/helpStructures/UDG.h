...
protected:
    ...
    //node ids, what is double?
    map<int, double> nodes;

    //adj list for nodes based on IDs
    map<int, list<int>> adj;

    //distance between nodes
    map<int, map<int, double>> length;

    //weight of Nodes? or Edge?
...
///////////////////////////////// UNDER CONSTRUCTION ////////////////////////////////////
//    void initLite(int numNodes, int sinkId, vector<int> x_coors, vector<int> y_coors){
//        V = numNodes;
//        sinkId = sinkId;
