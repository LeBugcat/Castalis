//
// Generated file, do not edit! Created by nedtool 5.6 from node/communication/mac/MacPacket.msg.
//
...
void MacPacket::copy(const MacPacket& other)
{
    ...
    this->bypassedWC = other.bypassedWC;
}
...
void MacPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->bypassedWC);
}
...
void MacPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->bypassedWC);
}
...
bool MacPacket::getBypassedWC() const
{
    return this->bypassedWC;
}

void MacPacket::setBypassedWC(bool bypassedWC)
{
    this->bypassedWC = bypassedWC;
}
...
int MacPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='b' && strcmp(fieldName, "bypassedWC")==0) return base+4;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string MacPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return bool2string(pp->getBypassedWC());
        default: return "";
    }
}
...
bool MacPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setBypassedWC(string2bool(value)); return true;
        default: return false;
    }
}
