...
class MacPacket : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    virtual bool getBypassedWC() const;
    virtual void setBypassedWC(bool bypassedWC);
};
...
/**
 * Class generated from <tt>node/communication/mac/MacPacket.msg:39</tt> by nedtool.
 * <pre>
