...
void WirelessChannel::initialize(int stage)
{
	...
	transmissionRange= pow(10.0,(95-PLd0)/(pathLossExponent*10));

//	throw cRuntimeError("WC debug trap");
...
//			    PLd = pathlossModel.computePathloss(dist);
...
//	//CALCULATE NODE MAX TX RANGE AS
//	//THE FURTHEST SIGNAL CAN GO WHILE
//	//STAYING AT LEAST 1 DBM ABOVE RADIO SENSITIVITY
//	double maxPld = maxTxPower - bidirectionalPathLossJitter - signalDeliveryThreshold - 1;
//	nodeTxRange = ;
}
