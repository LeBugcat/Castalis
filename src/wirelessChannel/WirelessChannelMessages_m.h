...
/**
 * Class generated from <tt>wirelessChannel/WirelessChannelMessages.msg:22</tt> by nedtool.
 * <pre>
 ...
 * </pre>
 */
class WirelessChannelSignalBeginWithChannel : public ::omnetpp::cMessage
{
  protected:
    int nodeID;
    double power_dBm;
  ...
  private:
    void copy(const WirelessChannelSignalBeginWithChannel& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const WirelessChannelSignalBeginWithChannel&);

  public:
    WirelessChannelSignalBeginWithChannel(const char *name=nullptr, short kind=0);
    WirelessChannelSignalBeginWithChannel(const WirelessChannelSignalBeginWithChannel& other);
    virtual ~WirelessChannelSignalBeginWithChannel();
    WirelessChannelSignalBeginWithChannel& operator=(const WirelessChannelSignalBeginWithChannel& other);
    virtual WirelessChannelSignalBeginWithChannel *dup() const override {return new WirelessChannelSignalBeginWithChannel(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
    ...
    virtual int getEncodingType() const;
    virtual void setEncodingType(int encodingType);
    virtual int getCurrentChannel() const;
    virtual void setCurrentChannel(int currentChannel);
};

inline void doParsimPacking(omnetpp::cCommBuffer *b, const WirelessChannelSignalBeginWithChannel& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, WirelessChannelSignalBeginWithChannel& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>wirelessChannel/WirelessChannelMessages.msg:35</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>wirelessChannel/WirelessChannelMessages.msg:39</tt> by nedtool.
 * <pre>
 ...
 * </pre>
 */
class WirelessChannelSignalEndWithChannel : public ::omnetpp::cPacket
{
  protected:
    int nodeID;
    int currentChannel;
  ...
  private:
    void copy(const WirelessChannelSignalEndWithChannel& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const WirelessChannelSignalEndWithChannel&);

  public:
    WirelessChannelSignalEndWithChannel(const char *name=nullptr, short kind=0);
    WirelessChannelSignalEndWithChannel(const WirelessChannelSignalEndWithChannel& other);
    virtual ~WirelessChannelSignalEndWithChannel();
    WirelessChannelSignalEndWithChannel& operator=(const WirelessChannelSignalEndWithChannel& other);
    virtual WirelessChannelSignalEndWithChannel *dup() const override {return new WirelessChannelSignalEndWithChannel(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const WirelessChannelSignalEndWithChannel& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, WirelessChannelSignalEndWithChannel& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>wirelessChannel/WirelessChannelMessages.msg:45</tt> by nedtool.
 * <pre>
