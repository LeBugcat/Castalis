...
////}
//
//    static vector<vector<int>> call(CastaliaModule &module, int sinkId, std::vector<int> landmarks, int numUAVs, double maxDelay, bool isBreak){
//        clock_t start = clock();
//        unsigned int seed = (unsigned int)time(NULL);
//
//        // printf("Seed = %d\n", seed);
...
//
//            population.clear();
//            environmental(frank, irank, &population, 50);
//
//            if (isBreak && (!frank.empty()) && ((frank[0]).front().maxDistance < maxDelay)) break;
//
//            auto stop = high_resolution_clock::now();
//            auto duration = duration_cast<microseconds>(stop - start);
//
...
//
//
//    static vector<vector<int>> call(CastaliaModule &module, int sinkId, std::vector<int> landmarks, int numUAVs, double maxDelay, vector<vector<int>> tours){
//        return Vrptw::call(module, sinkId, landmarks, numUAVs, maxDelay, false, tours);
//    }
//
//    static vector<vector<int>> call(CastaliaModule &module, int sinkId, std::vector<int> landmarks, int numUAVs, double maxDelay, bool isBreak, vector<vector<int>> tours){
//        clock_t start = clock();
//        unsigned int seed = (unsigned int)time(NULL);
//
//        // printf("Seed = %d\n", seed);
...
//                module.routingTrace() << "maxDistance = " << it->maxDistance;
//            }
