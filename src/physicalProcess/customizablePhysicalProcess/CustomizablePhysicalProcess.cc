...
void CustomizablePhysicalProcess::handleMessage(cMessage * msg)
{
	...
	switch (inputType) {
		...
		case TRACE_FILE:{
			/* 
			 * TODO_deprecated: add this functionality in the future
			 */
...
numSources);
	    ...
	    throw cRuntimeError("Unintended behavior");
		/*
		 * TODO_deprecated: add this functionality in the future for the reading of the TraceFile.
		 */
	}
}
